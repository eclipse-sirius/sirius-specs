...
For the new extension point, we will need to test the color, border color and border size with two new sample (circle.svg and circle2.svg and the old one (donut.svg):
...
<circle id="circle" cx="250" cy="250" r="210" stroke="#000" stroke-width="8"/>
	<color>#fff</color>
</circle>
